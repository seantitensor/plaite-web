...
import { getHistoryAuthFailures, computeGranularity } from '../../../../../lib/firebase/analytics';
...
export const GET: APIRoute = async (ctx) => {
	...
	try {
		...
		const buckets = await getHistoryAuthFailures(startDate, endDate, granularity, env);
